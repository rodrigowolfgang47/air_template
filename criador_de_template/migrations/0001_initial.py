...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cod_da_peca', models.CharField(max_length=10)),
                ('marca', models.CharField(max_length=20)),
                ('descricao', models.CharField(blank=True, max_length=150, null=True)),
                ('aplicacao', models.CharField(blank=True, max_length=150, null=True)),
                ('preco', models.DecimalField(decimal_places=2, max_digits=6)),
                ('destaque', models.BooleanField(default=False, null=True)),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='criador_de_template.cliente')),
            ],
        ),
    ]
